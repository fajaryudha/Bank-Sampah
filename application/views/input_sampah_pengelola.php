<div class="page-header">
	...
	<div class="row-fluid sortable">
					...
					<div class="box-content center">
						<form name="autoSumForm" class="form-horizontal" role="form" method="post" id="add_sampah" action="<?php echo base_url();?>index.php/sampah_pengelola/input_kelola_sampah">
							<fieldset>
							  ...
							  <div class="control-group">
										...
										<div class="controls">
										<input multiple="" type="file" id="id-input-file-3" name="foto" />
