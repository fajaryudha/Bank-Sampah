						...
						<table class="table center table-striped table-bordered bootstrap-datatable datatable">
											...
											<tbody>
												...
												<tr>
													...
													<td class="center">
														<a class="btn btn-info" href="<?php echo base_url(); ?>index.php/sampah_pengelola/tampil_sampah_done/<?php echo $data['id']; ?>">
																<i class="halflings-icon white edit"></i>  
															</a>
															<a class="btn btn-danger" href="<?php echo base_url(); ?>index.php/sampah_pengelola/hapus_sampah/<?php echo $data['id']; ?>">
