<div class="page-header">
	...
	<div class="row-fluid sortable">
					...
					<div class="box-content center">
						<form name="autoSumForm" class="form-horizontal" role="form" method="post" id="add_sampah" action="<?php echo base_url();?>index.php/sampah_pengelola/edit_kelola_sampah">
							<fieldset>
								...
								<div class="control-group">
							 	 ...
							 	 <div class="controls">
									<input required type="text" value="<?php echo $key->tgl_dikerjakan; ?>"  style="width: 300px" class="input-xlarge datepicker" id="date01" placeholder="Tanggal Dikerjakan" name="tgl_dikerjakan">
							 	</div>
								</div>
								<div class="control-group">
									...
									<div class="controls">
										<span><textarea required type="text" name="deskripsi" style="width: 300px" placeholder="Deskripsi" >
							  ...
							  <div class="control-group">
										...
										<div class="controls">
										<input multiple="" type="file" value="<?php echo $key->foto; ?>" id="id-input-file-3" name="foto" />
